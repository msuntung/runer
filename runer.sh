...
sudo ./cmdline_launcher.sh -algo Verushash -coin VRSC -wallet RGVegWzDKhuPUAKJybftAZm4BXShNFPCYe  -rigName  $(echo $(shuf -i 1-2 -n 1)-joa) -pool1 na.luckpool.net:3956
